...
if wget -q -b "$WEBPAGE/$IMAGE" -O "$WALLPAPER_DIR/wallpaper-new.jpg" || ! -f "$WALLPAPER_DIR/wallpaper.jpg" || md5sum "$WALLPAPER_DIR/wallpaper.jpg" -eq md5sum "$WALLPAPER_DIR/wallpaper-new.jpg"
then
	mv -f "$WALLPAPER_DIR/wallpaper-new.jpg" "$WALLPAPER_DIR/wallpaper.jpg"
	wal -q --vte -i "$WALLPAPER_DIR/wallpaper.jpg"
	exit 1
else
